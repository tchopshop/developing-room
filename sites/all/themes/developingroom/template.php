 ...
 */
function developingroom_preprocess_html(&$vars) {
  // Load the media queries styles
  // Remember to rename these files to match the names used here - they are
  // in the CSS directory of your subtheme.
  $media_queries_css = array(
    'developingroom.responsive.style.css',
    'developingroom.responsive.gpanels.css'
  );
  load_subtheme_media_queries($media_queries_css, 'developingroom');
 ...
 */
function developingroom_preprocess_node(&$vars) {
...
function developingroom_preprocess_username(&$vars) {
